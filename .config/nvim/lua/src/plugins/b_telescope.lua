...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>f', builtin.current_buffer_fuzzy_find, {}) -- space+d to search string across current file (buffer)
      vim.keymap.set('n', '<leader>d', builtin.live_grep, {})                 -- space+f to search string across all files
