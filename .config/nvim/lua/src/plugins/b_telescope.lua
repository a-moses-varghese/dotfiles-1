...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-t>", builtin.find_files, {})                    -- ctrl+p to search for file names
      vim.keymap.set("n", "<leader>t", builtin.current_buffer_fuzzy_find, {}) -- space+f to search string across current file (buffer)
      vim.keymap.set("n", "<leader>th", builtin.live_grep, {})                -- space+pf to search string across project files
