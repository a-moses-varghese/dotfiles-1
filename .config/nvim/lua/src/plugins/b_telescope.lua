...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-p>", builtin.find_files, {}) -- ctrl+p to search for file names
      vim.keymap.set("n", "<leader>f", builtin.current_buffer_fuzzy_find, {}) -- space+f to search string across current file (buffer)
      vim.keymap.set("n", "<leader>pf", builtin.live_grep, {}) -- space+pf to search string across project files
